...
export default function SettingsScreen() {
    ...
    const handleSavePlayer = async () => {
        ...
        const playerData = {
            ...
            initiativeBonus: (() => {
                const value = form.initiativeBonus.trim();
                if (!value) return 0;
        ...
        setEditPlayer(null);
        setForm({ name: '', race: '', class: '', maxHp: '', ac: '', passivePerception: '', initiativeBonus: '', tokenUrl: '' });
                        ...
                        <View style={{ backgroundColor: currentTheme.card, borderRadius: 12, padding: 24, marginBottom: 100, width: 320, maxWidth: '90%', maxHeight: Dimensions.get('window').height * 0.5 }}>
                            ...
                            <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={t => setForm(f => ({ ...f, initiativeBonus: t }))}
                                />
