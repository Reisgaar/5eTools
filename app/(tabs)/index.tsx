...
export default function HomeScreen() {
    ...
    const { campaigns, selectedCampaign, createCampaign, selectCampaign, deleteCampaign, updateCampaign, clearSelectedCampaign } = useCampaign();
            ...
            <ScrollView style={{ flex: 1, padding: 16 }}>
                ...
                <View style={{ marginBottom: 20 }}>
                    ...
                    <Text style={{ fontSize: 16, color: currentTheme.noticeText, marginBottom: 16 }}>
                        Select a campaign and manage your players
                    </Text>
                </View>
                                ...
                                renderItem={({ item, index }) => (
                                    <View style={[styles.campaignItem, { 
                                        ...
                                        <View style={styles.campaignActions}>
                                            <TouchableOpacity onPress={() => openEditCampaignModal(item)} style={{ marginRight: 12 }}>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => (
                                    ...
                                    <View style={styles.playerActions}>
                                        <TouchableOpacity onPress={() => openEditPlayerModal(item)} style={{ marginRight: 12 }}>
                                            <Ionicons name="pencil" size={16} color={currentTheme.primary} />
                                        </TouchableOpacity>
                                        <TouchableOpacity onPress={() => handleDeletePlayer(item.name)}>
                                            <Ionicons name="trash" size={16} color="#dc2626" />
                                        </TouchableOpacity>
                                    </View>
                                    </View>
            ...
            <Modal visible={campaignModalVisible} animationType="slide" transparent>
                <View style={styles.modalOverlay}>
                    <View style={[styles.modalContent, { backgroundColor: currentTheme.card }]}>
                        ...
                        <Text style={[styles.fieldLabel, { color: currentTheme.text }]}>Campaign Name</Text>
                        <TextInput
                            style={[styles.input, { backgroundColor: currentTheme.innerBackground, color: currentTheme.text }]}
                        ...
                        <Text style={[styles.fieldLabel, { color: currentTheme.text }]}>Description (Optional)</Text>
                        <TextInput
                            style={[styles.input, { backgroundColor: currentTheme.innerBackground, color: currentTheme.text }]}
                        ...
                        <View style={styles.modalButtons}>
                            <TouchableOpacity 
                                onPress={() => { setCampaignModalVisible(false); setEditCampaign(null); }} 
                                style={[styles.modalButton, { backgroundColor: '#eee', marginRight: 8 }]}
                            >
                                <Text style={[styles.modalButtonText, { color: 'black' }]}>Cancel</Text>
                            </TouchableOpacity>
                            <TouchableOpacity 
                                onPress={handleSaveCampaign} 
                                style={[styles.modalButton, { backgroundColor: currentTheme.primary, marginLeft: 8 }]}
                            >
                ...
                <View style={styles.modalOverlay}>
                    <View style={[styles.modalContent, { backgroundColor: currentTheme.card }]}>
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <Text style={[styles.fieldLabel, { color: currentTheme.text }]}>Initiative Bonus</Text>
                            <TextInput
                                style={[styles.input, { backgroundColor: currentTheme.innerBackground, color: currentTheme.text }]}
                        ...
                        <View style={styles.modalButtons}>
                            <TouchableOpacity 
                                onPress={() => { setPlayerModalVisible(false); setEditPlayer(null); }} 
                                style={[styles.modalButton, { backgroundColor: '#eee', marginRight: 8 }]}
                            >
                                <Text style={[styles.modalButtonText, { color: 'black' }]}>Cancel</Text>
                            </TouchableOpacity>
